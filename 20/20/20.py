...
# ------------------------------
class Mode(Enum):
    NAV = auto(); BOX_1 = auto(); BOX_2 = auto(); LINE_1 = auto(); LINE_2 = auto(); RESIZE = auto()
...
class Designer:
    ...
    def _draw(self):
            ...
            try:
                if isinstance(o, Box):
                    ...
                    for r, ln in enumerate(lines):
                        self.stdscr.addstr(o.y + r, o.x, ln[:1000], attr)
                elif isinstance(o, Line):
        ...
        stat = f"[{self.cur_screen.name}] {self.msg}{sel_name} | Pos:{self.cx},{self.cy}  (e:edit t:text b:box l:line r:resize)"
        try:
