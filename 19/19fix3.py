...
class GuiManager:
    ...
    def _run(self):
        ...
        # keep it on top for easier access
        try:
    ...
    def _emit(self, cmd):
        ...
        # Always push the command (even if data is None for SAVE_ASSET to open dialog)
    ...
    def _refresh_assets(self):
        ...
        for k in sorted(self._load_lib().keys()): 
    ...
    def save_project(self, screens: List[Screen]):
        ...
        for s in screens:
            ...
            for obj in s.objects:
                ...
                # ensure name is a valid identifier by basic sanitation
...
class Designer:
    ...
    def _handle_key(self, k):
        ...
        if self.mode == Mode.NAV:
            ...
            # use keyword-only instantiation to avoid dataclass positional argument pitfalls
    ...
    def _draw_interface(self):
        ...
        for i, o in enumerate(self.cur_objs):
            ...
            try:
                ...
                # ignore drawing outside the screen bounds
                pass
        ...
        try:
            ...
            # Move physical cursor within safe bounds
